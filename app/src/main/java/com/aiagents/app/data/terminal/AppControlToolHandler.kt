...
- "set_display": Toggle display options. Params: show_reasoning (true/false), show_commands (true/false)""",
    ...
    private suspend fun getStatus(toolCallId: String, workspaceId: Long): AppControlResult {
        ...
        val services = buildList {
            ...
            if (securePreferences.hasGoogleDriveConfig() || securePreferences.hasGoogleWorkspaceConfig()) add("Google Workspace")
    ...
    private fun listServices(toolCallId: String): AppControlResult {
        val info = buildString {
            ...
            appendLine("  google_workspace: ${if (securePreferences.hasGoogleWorkspaceConfig() || securePreferences.hasGoogleDriveConfig()) "configured" else "not configured"}")
